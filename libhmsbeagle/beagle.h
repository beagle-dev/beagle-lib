...
enum BeagleFlags {
    ...
    BEAGLE_FLAG_FRAMEWORK_METAL     = 1 << 24,   /**< Use Metal implementation with GPU resources (macOS/Apple Silicon) */
    BEAGLE_FLAG_FRAMEWORK_ROCM      = 1 << 25,   /**< Use ROCm/HIP implementation with AMD GPU resources */
