 ...
 * Each capability is a bit in a 'long long (64-bit)'
 */
enum BeagleFlags {
    BEAGLE_FLAG_PRECISION_SINGLE    = 1ll << 0,    /**< Single precision computation */
    BEAGLE_FLAG_PRECISION_DOUBLE    = 1ll << 1,    /**< Double precision computation */
    
    BEAGLE_FLAG_COMPUTATION_SYNCH   = 1ll << 2,    /**< Synchronous computation (blocking) */
    BEAGLE_FLAG_COMPUTATION_ASYNCH  = 1ll << 3,    /**< Asynchronous computation (non-blocking) */
    
    BEAGLE_FLAG_EIGEN_REAL          = 1ll << 4,    /**< Real eigenvalue computation */
    BEAGLE_FLAG_EIGEN_COMPLEX       = 1ll << 5,    /**< Complex eigenvalue computation */
    
    BEAGLE_FLAG_SCALING_MANUAL      = 1ll << 6,    /**< Manual scaling */
    BEAGLE_FLAG_SCALING_AUTO        = 1ll << 7,    /**< Auto-scaling on (deprecated, may not work correctly) */
    BEAGLE_FLAG_SCALING_ALWAYS      = 1ll << 8,    /**< Scale at every updatePartials (deprecated, may not work correctly) */
    BEAGLE_FLAG_SCALING_DYNAMIC     = 1ll << 25,   /**< Manual scaling with dynamic checking (deprecated, may not work correctly) */
    
    BEAGLE_FLAG_SCALERS_RAW         = 1ll << 9,    /**< Save raw scalers */
    BEAGLE_FLAG_SCALERS_LOG         = 1ll << 10,   /**< Save log scalers */
    
    BEAGLE_FLAG_INVEVEC_STANDARD    = 1ll << 20,   /**< Inverse eigen vectors passed to BEAGLE have not been transposed */
    BEAGLE_FLAG_INVEVEC_TRANSPOSED  = 1ll << 21,   /**< Inverse eigen vectors passed to BEAGLE have been transposed */
    
    BEAGLE_FLAG_VECTOR_SSE          = 1ll << 11,   /**< SSE computation */
    BEAGLE_FLAG_VECTOR_AVX          = 1ll << 24,   /**< AVX computation */
    BEAGLE_FLAG_VECTOR_NONE         = 1ll << 12,   /**< No vector computation */
    
    BEAGLE_FLAG_THREADING_CPP       = 1ll << 30,   /**< C++11 threading */
    BEAGLE_FLAG_THREADING_OPENMP    = 1ll << 13,   /**< OpenMP threading */
    BEAGLE_FLAG_THREADING_NONE      = 1ll << 14,   /**< No threading (default) */
    
    BEAGLE_FLAG_PROCESSOR_CPU       = 1ll << 15,   /**< Use CPU as main processor */
    BEAGLE_FLAG_PROCESSOR_GPU       = 1ll << 16,   /**< Use GPU as main processor */
    BEAGLE_FLAG_PROCESSOR_FPGA      = 1ll << 17,   /**< Use FPGA as main processor */
    BEAGLE_FLAG_PROCESSOR_CELL      = 1ll << 18,   /**< Use Cell as main processor */
    BEAGLE_FLAG_PROCESSOR_PHI       = 1ll << 19,   /**< Use Intel Phi as main processor */
    BEAGLE_FLAG_PROCESSOR_OTHER     = 1ll << 26,   /**< Use other type of processor */
    
    BEAGLE_FLAG_FRAMEWORK_CUDA      = 1ll << 22,   /**< Use CUDA implementation with GPU resources */
    BEAGLE_FLAG_FRAMEWORK_OPENCL    = 1ll << 23,   /**< Use OpenCL implementation with GPU resources */
    BEAGLE_FLAG_FRAMEWORK_CPU       = 1ll << 27,   /**< Use CPU implementation */
    ...
    BEAGLE_FLAG_PREORDER_TRANSPOSE_LOW_MEMORY = 1UL << 32 /**< Use low-memory automatic matrix transpose */
};
...
/**
 * @brief Size of resource flags
 */
typedef long long BeagleFlagsType;
...
typedef struct {
    ...
    BeagleFlagsType flags;         /**< Bit-flags that characterize the activate
