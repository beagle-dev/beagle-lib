...
class BEAGLE_DLLEXPORT TensorCoresPlugin : public beagle::plugin::Plugin
{
public:
    TensorCoresPlugin();
	~TensorCoresPlugin();
private:
    TensorCoresPlugin( const TensorCoresPlugin& cp );	// disallow copy by defining this private
};
