...
nvcc.exe -o tmp_kernels_sp_4.ptx -ptx -arch compute_30 -I../../.. -DCUDA -O3 -m64 tmp_kernels_sp_4.cu
...
nvcc.exe -o tmp_kernels_sp_%%G.ptx -ptx -arch compute_30 -I../../.. -DCUDA -O3 -m64 tmp_kernels_sp_%%G.cu
...
nvcc.exe -o tmp_kernels_dp_4.ptx -ptx -arch compute_30 -I../../.. -DCUDA -O3 -m64 tmp_kernels_dp_4.cu
...
nvcc.exe -o tmp_kernels_dp_%%G.ptx -ptx -arch compute_30 -I../../.. -DCUDA -O3 -m64 tmp_kernels_dp_%%G.cu
