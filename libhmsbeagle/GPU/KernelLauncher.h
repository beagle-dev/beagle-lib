...
GPUPtr operations, GPUPtr sizes, GPUPtr coalescent, unsigned int intervalNumber, unsigned int start, unsigned int numOps, unsigned int patternCount);
	...
	void reduceWithinIntervalSerial(GPUPtr operations, GPUPtr partials, GPUPtr dBastaMemory, GPUPtr intervals, unsigned int numOps, unsigned int start, unsigned int end, unsigned int kCoalescentBufferLength);
