...
#define BEAGLE_CPU_ASYNC_MIN_PATTERN_COUNT_LOW         16  // do not use CPU auto-threading for problems with fewer patterns on CPUs with many cores
#define BEAGLE_CPU_ASYNC_MIN_PATTERN_COUNT_HIGH        48  // do not use CPU auto-threading for problems with fewer patterns on CPUs with few cores
