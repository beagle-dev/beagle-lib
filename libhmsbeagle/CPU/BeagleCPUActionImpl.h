...
namespace beagle {
    namespace cpu {
        ...
        class BeagleCPUActionImpl : public BeagleCPUImpl<BEAGLE_CPU_GENERIC> {
            ...
            void
            calcStatesPartials(double *destP, const int *states_q, const double *matrices_q, const double *partials_r,
                               const double *matrices_r, int startPattern, int endPattern);
        };

        BEAGLE_CPU_ACTION_TEMPLATE
        class BeagleCPUActionImpl<BEAGLE_CPU_ACTION_FLOAT> : public BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT> {

        protected:
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kTipCount;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gPartials;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::integrationTmp;
//            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gTransitionMatrices;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kPatternCount;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kPaddedPatternCount;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kExtraPatterns;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kStateCount;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gTipStates;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kCategoryCount;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gScaleBuffers;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gCategoryWeights;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::gStateFrequencies;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::realtypeMin;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kMatrixSize;
            using BeagleCPUImpl<BEAGLE_CPU_ACTION_FLOAT>::kPartialsPaddedStateCount;
