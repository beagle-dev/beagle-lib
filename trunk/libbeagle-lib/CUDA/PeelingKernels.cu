...
__global__ void kernelPartialsPartialsEdgeLikelihoodsFixedScaling(REAL* dPartialsTmp,
                                                                  REAL* dParentPartials,
                                                                  REAL* dChildParials,
                                                                  REAL* dTransMatrix,
                                                                  REAL* scalingFactors,
    ...
    if (pattern < totalPatterns)
        dPartialsTmp[u] = sum1 * sPartials2[patIdx][state] / fixedScalingFactors[patIdx];
}
...
__global__ void kernelStatesPartialsEdgeLikelihoodsFixedScaling(REAL* dPartialsTmp,
                                                                REAL* dParentPartials,
                                                                int* dChildStates,
                                                                REAL* dTransMatrix,
                                                                REAL* scalingFactors,
...
__global__ void kernelPartialsPartialsEdgeLikelihoodsSmallFixedScaling(REAL* dPartialsTmp,
                                                                       REAL* dParentPartials,
                                                                       REAL* dChildParials,
                                                                       REAL* dTransMatrix,
                                                                       REAL* scalingFactors,
